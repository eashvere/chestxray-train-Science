...
from keras.layers import Input, Dense, Convolution2D, MaxPooling2D, AveragePooling2D, ZeroPadding2D, Dropout, Flatten, add, Reshape, Activation, Lambda, GlobalAveragePooling2D, Merge
...
def resnet101_model(weights_path=None):
    ...
    x = Convolution2D(64, (7, 7), strides=(
        2, 2), name='conv1', use_bias=False)(x)
...
def get_resnet101(classes_number, dim_ordering='th'):
    #base_model = resnet101_model(WEIGHTS_PATH + 'resnet101_weights_tf.h5')
    base_model = resnet101_model(None)
